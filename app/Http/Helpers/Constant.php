...
if (!function_exists('noImage')) {
    function noImage()
    {
        return staticAsset("frontend/default/assets/img/no-data-found.png");
    }
}
...
if (!function_exists('create_file')) {
    /**
     * Create report file by Call Center
     *
    ...
    {
        file_put_contents(public_path($fileName), $data . PHP_EOL, FILE_APPEND);
    }
}

if (!function_exists('create_body')) {

    function create_body($filename, $txt)
    {
