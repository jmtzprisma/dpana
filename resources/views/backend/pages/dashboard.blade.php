                    ...
                    <div class="col-12">
                        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card tt-page-header">
                                <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                                    <div class="tt-page-title">
                                        <h6 for="tipo_cambio" class="h6 mb-lg-0">Tipo de cambio 1 USD</h6>
                                    </div>
                                    <div class="tt-action d-lg-flex align-items-center justify-content-lg-between">
                                        <input type="hidden" name="types[]" value="tipo_cambio">
                                        <input type="text" class="form-control" id="tipo_cambio" name="tipo_cambio" value="{{ getSetting('tipo_cambio') }}" placeholder="Bolivares">
                                        
                                        <button type="submit" class="btn btn-success ms-2"><i data-feather="save" class="me-2"></i>{{ localize('Save') }}&nbsp;&nbsp;</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="card h-100 flex-column">
                            <div class="card-body px-0">
                                @php
                                $top_selling_product_count = \App\Models\Product::whereIn('id', function ($query) {
                                    $query->select('product_variations.product_id')
                                        ->from('order_items')
                                        ->join('product_variations', 'order_items.product_variation_id', '=', 'product_variations.id')
                                        ->whereIn('order_items.order_id', \App\Models\Order::byLocation()->pluck('id'));
                                })->count();
                            @endphp
                            ...
                            <div class="px-3">
                                ...
                                <span class="text-muted">
                                    {{ localize('We have listed ' . $top_selling_product_count . ' total products.') }}
                                </span>
                            </div>
                            <div class="tt-top-selling mt-3 h-25rem" data-simplebar>
                                <ul class="tt-top-selling-list list-unstyled mb-0 px-3">
                                    @php
                                        $top_selling_products = \App\Models\Product::whereIn('id', function ($query) {
                                            $query->select('product_variations.product_id')
                                                ->from('order_items')
                                                ->join('product_variations', 'order_items.product_variation_id', '=', 'product_variations.id')
                                                ->whereIn('order_items.order_id', \App\Models\Order::byLocation()->pluck('id'));
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::byLocation()->count() }}</h4>
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isPlacedOrPending()->byLocation()->count() }}</h4>
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isProcessing()->byLocation()->count() }}</h4>
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isDelivered()->byLocation()->count() }}</h4>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="card">
                                ...
                                @php
                                    $orders = App\Models\Order::byLocation()
                                        ->latest()
                                        ->take(10)
                                        ->get();
                                @endphp
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isPickedUp()->byLocation()->count() }}</h4>
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isCancelled()->byLocation()->count() }}</h4>
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isOutForDelivery()->byLocation()->count() }}</h4>
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isPaid()->byLocation()->count() }}</h4>
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1">{{ \App\Models\Order::isUnpaid()->byLocation()->count() }}</h4>
                        ...
                        <div class="card h-100 flex-column">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <h4 class="mb-1">{{ $totalSaleCount }}</h4>
                        ...
                        <div class="card h-100 flex-column">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <h4 class="mb-1">{{ \App\Models\User::where('user_type', 'customer')->byLocation()->count() }}</h4>
                                        </h4>
                        ...
                        <div class="card h-100 flex-column">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <h4 class="mb-1">{{ $totalCategoriesWithStock }}</h4>
