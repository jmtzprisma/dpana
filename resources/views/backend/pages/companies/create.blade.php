...
@section('title')
    {{ localize('Add New Company') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
        ...
        <div class="container">
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">{{ localize('Add Company') }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    <form action="{{ route('admin.companies.store') }}" method="POST" class="pb-650">
                        @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="name"
                                        placeholder="{{ localize('Type company name') }}" name="name" required>
                                </div>
