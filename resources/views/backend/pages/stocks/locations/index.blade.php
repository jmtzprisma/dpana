                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-breakpoints="xs sm md">{{ localize('Teléfono') }}</th>
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown tt-tb-dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    @endcan
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.locations.downloadQrPdf', ['id' => $location->id]) }}">
                                                        <i data-feather="download" class="me-2"></i>{{ localize('Download QR') }}
                                                    </a>
