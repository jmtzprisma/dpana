                ...
                <form action="{{ route('admin.staffs.store') }}" method="POST" class="pb-650">
                    ...
                    <div class="card mb-4" id="section-1">
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <label class="form-label">{{ localize('Location') }}<span class="text-danger ms-1">*</span></label>
                                <select class="select2 form-control" data-toggle="select2" name="location_id" required>
