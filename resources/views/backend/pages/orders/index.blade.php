                            ...
                            <div class="tt-page-title">
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                      <button class="nav-link active" id="nav-deliver-orders-tab" data-bs-toggle="tab" data-bs-target="#nav-deliver-orders" type="button" role="tab" aria-controls="nav-deliver-orders" aria-selected="true">{{ localize('Deliver Orders') }}</button>
                                      <button class="nav-link" id="nav-orders-tab" data-bs-toggle="tab" data-bs-target="#nav-orders" type="button" role="tab" aria-controls="nav-orders" aria-selected="false">{{ localize('Orders') }}</button>
                                    </div>
                                </nav>
                                <h2 class="h5 mb-lg-0">
                                </h2>
                ...
                <div class="col-12">
                    <div class="card mb-4" id="section-1">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-deliver-orders" role="tabpanel" aria-labelledby="nav-deliver-orders-tab">
                                        ...
                                        @foreach ($deliver_orders as $key => $order)
                                            <tr>
                                                <td class="text-center">
                                                    {{ $key + 1 + ($deliver_orders->currentPage() - 1) * $deliver_orders->perPage() }}</td>
                                ...
                                <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                                    <span>{{ localize('Showing') }}
                                        {{ $deliver_orders->firstItem() }}-{{ $deliver_orders->lastItem() }} {{ localize('of') }}
                                        {{ $deliver_orders->total() }} {{ localize('results') }}</span>
                                    <nav>
                                        {{ $deliver_orders->appends(request()->input())->links() }}
                                    </nav>
                                </div>
                                <!--pagination end-->
