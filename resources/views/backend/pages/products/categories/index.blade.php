                                            ...
                                            <div class="dropdown tt-tb-dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.categories.status', ['id' => $category->id]) }}">
                                                        <i data-feather="{{ $category->status ? 'x' : 'check'}}" class="me-2"></i>{{ $category->status ? localize('Desactivar') : localize('Activar') }}
                                                    </a>
                                                    @can('edit_categories')
                                                        <a class="dropdown-item"
