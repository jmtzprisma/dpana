<ul class="tt-side-nav">
    ...
    @can('orders')
        <li
            class="side-nav-item nav-item {{ areActiveRoutes(['admin.orderspayments.index'], 'tt-menu-item-active') }}">
            <a href="{{ route('admin.orderspayments.index') }}"
                class="side-nav-link {{ areActiveRoutes(['admin.orderspayments.index']) }}">
                <span class="tt-nav-link-icon"><i data-feather="dollar-sign"></i></span>
                <span class="tt-nav-link-text">
                    <span>{{ localize('Orders Payments') }}</span>
                </span>
            </a>
        </li>
    @endcan
    <!--pharmacy-->
    @php
        $stockActiveRoutes = ['admin.locations.index', 'admin.locations.create', 'admin.locations.edit'];
    @endphp
    @canany(['show_locations'])
        <li class="side-nav-item nav-item {{ areActiveRoutes($stockActiveRoutes, 'tt-menu-item-active') }}">
            <a data-bs-toggle="collapse" href="#managePharmacy"
               aria-expanded="{{ areActiveRoutes($stockActiveRoutes, 'true') }}" aria-controls="pharmacy"
               class="side-nav-link tt-menu-toggle">
                <span class="tt-nav-link-icon"><i data-feather="package"></i></span>
                <span class="tt-nav-link-text">{{ localize('Pharmacy') }}</span>
            </a>
            <div class="collapse {{ areActiveRoutes($stockActiveRoutes, 'show') }}" id="managePharmacy">
                <ul class="side-nav-second-level">
                    @can('show_locations')
                        <li
                    ...
                    @endcan
                    <li
                        class="{{ areActiveRoutes(['admin.companies.index', 'admin.companies.create', 'admin.companies.edit'], 'tt-menu-item-active') }}">
                        <a href="{{ route('admin.companies.index') }}">{{ localize('All Companies') }}</a>
                    </li>
                </ul>
            </div>
        </li>
    ...
    <!-- stock -->
    @php
        $stockActiveRoutes = ['admin.stocks.create'];
    @endphp
    @canany(['add_stock'])
        <li class="side-nav-item nav-item {{ areActiveRoutes($stockActiveRoutes, 'tt-menu-item-active') }}">
            ...
            <div class="collapse {{ areActiveRoutes($stockActiveRoutes, 'show') }}" id="manageStock">
                <ul class="side-nav-second-level">
                    ...
                    @can('add_stock')
                        ...
                        <li class="{{ areActiveRoutes(['admin.stocks.index'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.stocks.index') }}"
                                class="{{ areActiveRoutes(['admin.stocks.index']) }}">{{ localize('Manage Stock') }}</a>
                        </li>
                    @endcan
                </ul>
            </div>
    ...
    @canany(['customers', 'staffs', 'add_deliveryman', 'edit_deliveryman', 'delete_deliveryman', 'assign_deliveryman', 'deliveryman_config', 'deliveryman_list'])
    <!-- Users -->
                ...
                <ul class="side-nav-second-level">
                    ...
                    @can('deliveryman_payroll_list')
                        <li class="{{ areActiveRoutes(['admin.deliveryman.payroll.list'], 'tt-menu-item-active') }}">
                            <a href="{{ route('admin.deliveryman.payroll.list') }}">{{ localize('Deliveryman Payroll List') }}</a>
                        </li>
                    @endcan
    ...
    @canany(['homepage'])
        <li class="side-nav-item nav-item {{ areActiveRoutes($groceryActiveRoutes, 'tt-menu-item-active') }}">
            <a data-bs-toggle="collapse" href="#groceryOutlook"
                ...
                <span class="tt-nav-link-text">{{ localize('EDS Theme') }}</span>
            </a>
    ...
    @canany(['newsletters', 'subscribers', 'roles_and_permissions', 'smtp_settings', 'general_settings', 'currency_settings', 'language_settings'])
    <!-- Settings -->
    <li class="side-nav-title side-nav-item nav-item mt-3">
        ...
        <li class="side-nav-item nav-item {{ areActiveRoutes($settingsActiveRoutes, 'tt-menu-item-active') }}">
            ...
            <div class="collapse {{ areActiveRoutes($settingsActiveRoutes, 'show') }}" id="systemSetting">
                <ul class="side-nav-second-level">
                    ...
                    <li class="{{ areActiveRoutes(['admin.methods.index'], 'tt-menu-item-active') }}">
                        <a href="{{ route('admin.methods.index') }}"
                            class="{{ areActiveRoutes(['admin.methods.index']) }}">{{ localize('Metodos de Pago') }}</a>
                    </li>
                    <li class="{{ areActiveRoutes(['admin.settings.limits_credit'], 'tt-menu-item-active') }}">
                        <a href="{{ route('admin.settings.limits_credit') }}"
                            class="{{ areActiveRoutes(['admin.settings.limits_credit']) }}">{{ localize('Limites de crédito') }}</a>
                    </li>
