<div class="offcanvas_menu position-fixed">
    <div class="tt-short-info d-none d-md-none d-lg-none d-xl-block">
        ...
        <div class="offcanvas-content">
            <h4 class="mb-4">{{ localize('About Us') }}</h4>
            <p>{{ getSetting('about_us') }}</p>
            <a href="{{ route('home.pages.aboutUs') }}" class="btn btn-primary mt-4">{{ localize('About Us') }}</a>
        </div>
    </div>
    ...
    <div class="offcanvas-contact mt-4">
        <h5 class="mb-4 mt-5">{{ 'Información de contacto' }}</h5>
        <address>
