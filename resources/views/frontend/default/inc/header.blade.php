            ...
            <div class="row align-items-center">
                <div class="col-xxl-2 col-xl-3 col-md-3 col-5">
                    <a href="{{ route('home') }}" class="logo"><img
                            src="{{ uploadedAsset(getSetting('navbar_logo')) }}" alt="logo" class="img-fluid" style="max-width: 80%;"></a>
                </div>
                <div class="col-xxl-10 col-xl-9 col-md-9 col-7">
                    <div class="gshop-navbar-right d-flex align-items-center justify-content-end position-relative">
                        ...
                        <nav class="gshop-navmenu ms-3 d-none d-xl-block">
                            <ul class="d-flex align-itmes-center justify-content-end">
                                            ...
                                            <li class="has-submenu">
                                                ...
                                                <ul>
                                                    @foreach ($activeThemes as $key => $theme)
                                                        <li style="font-family: Futura Bold;">
                                ...
                                @if(getSetting('show_theme_changes') == 0 || !getSetting('show_theme_changes'))
                                    <li><a href="{{ route('home') }}" style="font-family: Futura Bold;">{{ localize('Home') }}</a></li>
                                @endif
                                    <li><a href="{{ route('products.index') }}" style="font-family: Futura Bold;">{{ localize('Products') }}</a></li>
                                    <li><a href="{{ route('home.campaigns') }}" style="font-family: Futura Bold;">{{ localize('Campaigns') }}</a>
                                    </li>
                                    <li><a href="{{ route('home.coupons') }}" style="font-family: Futura Bold;">{{ localize('Coupons') }}</a>
                                    </li>
                                @endif
                                ...
                                @if (getSetting('show_navbar_pages') != 0 || getSetting('show_navbar_pages') == null)
                                    <li class="has-submenu">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ route('home.blogs') }}" style="font-family: Futura Bold;">{{ localize('Blogs') }}</a></li>
                                            <li><a
                                                    href="{{ route('home.pages.aboutUs') }}" style="font-family: Futura Bold;">{{ localize('About Us') }}</a>
                                            </li>
                                            <li><a
                                                    href="{{ route('home.pages.contactUs') }}" style="font-family: Futura Bold;">{{ localize('Contact Us') }}</a>
                                            </li>
                        ...
                        <div class="gshop-header-icons d-none d-md-inline-flex align-items-center justify-content-end ms-3 mx-3">
                            <div class="gshop-header-search dropdown">
                                <button type="button" class="header-icon" data-bs-toggle="dropdown">
                                    ...
                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 485.213 485.213" style="enable-background:new 0 0 485.213 485.213;" xml:space="preserve">
                                        <g>
                                            <g>
                            ...
                            <div class="gshop-header-cart position-relative">
                                ...
                                <button type="button" class="header-icon">
                                    ...
                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="25px" height="25px" viewBox="0 0 19.25 19.25" style="enable-background:new 0 0 19.25 19.25;" xml:space="preserve">
                                        <g>
                                            <g id="Layer_1_107_">
                                                <g>
                        ...
                        <button class="gshop-offcanvas-btn offcanvas-toggle ms-3 mx-3 my-3" style="background-color: transparent !important; border: 1px solid #efb810">
                            <img src="{{ staticAsset('frontend/default/assets/img/home1/boton.svg') }}" alt="My Happy SVG"/>
