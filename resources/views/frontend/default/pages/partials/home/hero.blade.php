<section class="gshop-hero pt-120 bg-white position-relative z-1 overflow-hidden">
                    ...
                    <div class="swiper-slide gshop-hero-single">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-xl-6 col-lg-5">
                                <div class="hero-right text-center position-relative z-1 mt-6 mt-xl-0" style="min-height: 40rem;">
    ...
    @if(getSetting('facebook_link') || getSetting('twitter_link') || getSetting('linkedin_link') || getSetting('youtube_link'))
        <div class="gs-hero-social" style="right: 0 !important; left: auto;">
            ...
            <span class="title fw-medium">{{localize('Síguenos en')}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
        </div>
    @endif
