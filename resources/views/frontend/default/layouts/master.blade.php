...
<body>
    ...
    <!--preloader start-->
    <div id="preloader">
        <img src="{{ staticAsset('frontend/default/assets/img/logo_company.png?v4') }}" alt="preloader" class="img-fluid">
    </div>
    <!--preloader end-->
    ...
    <div class="{{ $wrapperClass }}">
        ...
        <button class="scroll-top-btn">
            <img src="{{ staticAsset('frontend/default/assets/img/home1/flecha.svg') }}" alt="My Happy SVG"/>
