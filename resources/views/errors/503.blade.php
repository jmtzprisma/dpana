            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="content-404 text-center">
                        <img src="{{ staticAsset('frontend/default/assets/img/503.webp') }}" alt="not found"
                            class="img-fluid">
                        <h5 class="mt-4">Estamos creando nuevos medicamentos para ti.</h5>
                        <p class="mb-6">Volveremos pronto</p>
                    </div>
                </div>
            </div>
        </div>
