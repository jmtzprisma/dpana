...
use App\Http\Controllers\Backend\OrderPaymentsController;
...
use App\Http\Controllers\Backend\MethodsController;
...
Route::group(
    ...
    function () {
        ...
        #limist credit
        Route::get('/limits-credit', [SettingsController::class, 'limits_credit'])->name('admin.settings.limits_credit');
        Route::post('/limits-credit-save', [SettingsController::class, 'limits_credit_save'])->name('admin.limits_credit.store');
        Route::post('/num-cuotas-save', [SettingsController::class, 'num_cuotas_save'])->name('admin.num_cuotas.store');
        
        #methods payment
        Route::get('/methods', [MethodsController::class, 'index'])->name('admin.methods.index');
        Route::post('/method', [MethodsController::class, 'store'])->name('admin.methods.store');
        Route::get('/methods/edit/{id}', [MethodsController::class, 'edit'])->name('admin.methods.edit');
        Route::post('/methods/update-method', [MethodsController::class, 'update'])->name('admin.methods.update');
        Route::get('/methods/delete/{id}', [MethodsController::class, 'delete'])->name('admin.methods.delete');
        ...
        Route::group(['prefix' => 'products'], function () {
            ...
            Route::get('/status/{id}', [CategoriesController::class, 'updateStatus'])->name('admin.categories.status');
        ...
        # payments
        Route::group(['prefix' => 'orderspayments'], function () {
            Route::get('/', [OrderPaymentsController::class, 'index'])->name('admin.orderspayments.index');
            Route::get('/pay/{orderId}', [OrderPaymentsController::class, 'pay'])->name('admin.orderspayments.pay');
            Route::post('/order-new', [OrderPaymentsController::class, 'addOrder'])->name('admin.orderspayments.addOrder');
            Route::get('/get-user', [OrderPaymentsController::class, 'getUser'])->name('admin.orderspayments.get_user');
        });
        ...
        Route::group(['prefix' => 'stocks'], function () {
            ...
            Route::get('/manage-stocks', [StocksController::class, 'index'])->name('admin.stocks.index');
            Route::post('/manage-stocks', [StocksController::class, 'updateStock'])->name('stocks.update');


            # locations
            Route::get('/locations', [LocationsController::class, 'index'])->name('admin.locations.index');
            Route::get('/location-qr-download/{id}', [LocationsController::class, 'downloadPdfQr'])->name('admin.locations.downloadQrPdf');
